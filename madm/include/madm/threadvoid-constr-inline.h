        ...
        thread(F f, T0& arg0, T1& arg1, T2& arg2)
            : impl_([=] {
              // init thread local storage
              madi::thread_storage tls;
        ...
        thread(F f, T0& arg0, T1& arg1, T2& arg2, T3& arg3)
            : impl_([=] {
              // init thread local storage
              madi::thread_storage tls;
        ...
        thread(F f, T0& arg0, T1& arg1, T2& arg2, T3& arg3, T4& arg4)
            : impl_([=] {
              // init thread local storage
              madi::thread_storage tls;
        ...
        thread(F f, T0& arg0, T1& arg1, T2& arg2, T3& arg3, T4& arg4, T5& arg5)
            : impl_([=] {
              // init thread local storage
              madi::thread_storage tls;
        ...
        thread(F f, T0& arg0, T1& arg1, T2& arg2, T3& arg3, T4& arg4, T5& arg5, T6& arg6)
            : impl_([=] {
              // init thread local storage
              madi::thread_storage tls;
